...
/*creamos la clase Envigado que es una subcalse de Medellin por eso se le añade la palabra reservada extends y luego el nombre de la supercalse
...
public class Envigado extends Medellin{
    
    //Se crea el construtor que le permite heredar los métodos y atributos que la clase medellin heredó de la clase bogota
    public Envigado(String tipo, String peso, String descripcion, String destino, String envia, String origen) {
